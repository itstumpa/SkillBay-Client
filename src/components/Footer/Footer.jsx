...
const Footer = () => {
  return (
    <footer className="px-4 lg:px-10  divide-y dark:bg-gray-100 dark:text-gray-800">
	<div className="max-w-[1470px] pt-52 flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
