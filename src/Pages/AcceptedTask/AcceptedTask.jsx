      ...
      <div className="max-w-[1470px] mx-auto lg:px-10 md:px-6 px-4">
        ...
        <div className="mb-8 sm:mb-12 md:mb-16 relative">
          ...
          <div className="relative text-center">
            ...
            <h1 className="text-3xl text-white sm:text-4xl md:text-5xl lg:text-6xl font-black mb-3 sm:mb-4 tracking-tight px-2">
              My <span className="text-[#1a9641]">Applications</span>
            </h1>
            <p className="text-sm sm:text-base md:text-lg max-w-2xl mx-auto px-4">
              Review and manage all jobs you have applied for.
            </p>
          </div>
        </div>
